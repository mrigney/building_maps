...
### Data Files
- **`manifest.json`** - Building metadata and positions
- **`material_mapping.json`** - Material groupings for buildings
- **`models/`** - Directory containing 21 GLB 3D model files

### Visualization Files
- **`building_map.html`** - Interactive 2D map (open in browser)
- **`building_viewer_3d.html`** - Interactive 3D viewer (open in browser)
- **`building_visualization.png`** - Static matplotlib visualization

## How to View

### Quick View
Open these files in your web browser:
- `building_map.html` - See buildings on a 2D map
- `building_viewer_3d.html` - Explore buildings in 3D
...
### Notable Buildings
- **Tallest:** osm_232080287 (138.0m) - Appears to be a high-rise
- **Largest:** osm_35824976 (4,686 m²) - Hotel
...
Building data sourced from [OpenStreetMap](https://www.openstreetmap.org/) via the Overpass API.
